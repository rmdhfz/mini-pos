                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Laporan Pembelian Perproduk</h5> <br> <br><br>
                        ...
                        <div class="card-block">
                            <div class="dt-responsive table-responsive">
                                <center>
                                    <h2>Laporan Pembelian Perproduk</h2>
                                    <small>Source: minipos.majoo.id</small>
                                    <div class="container">
                                        <hr>
                                    </div> 
                                </center> <br>  <br> 
                                <table id="table-purchase" class="table nowrap" style="width: 100%;" hidden="1">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Supplier</th>
    ...
    $(document).ready(function() {
        ...
        function searchReport(from, to, product_id)
        {
            table = $("#table-purchase").DataTable({
                ...
                ajax: {
                    type: "post",
                    url: "<?php echo site_url('report/pembelian/produk'); ?>",
            ...
            $("#table-purchase").prop('hidden', false);
        }
